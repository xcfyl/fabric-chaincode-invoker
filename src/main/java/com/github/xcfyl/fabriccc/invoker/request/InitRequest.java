...
public class InitRequest extends AbstractFabricRequest<String> {
    public InitRequest(FabricContext context, ResultHandler<String> resultHandler, long timeout) {
        super(context.getAdmin(), context, String.class, null, resultHandler, timeout);
    }
    ...
    protected Collection<ProposalResponse> getResponses() throws Exception {
        ...
        String policyPath = fabricContext.getConfig().getChainCodeConfig().getPolicyPath();
